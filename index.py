...
cadastre_fr1 = Button(fr1, text=" Cadastre-se ", bg="#eb8334", fg="#fff",width=18, height=2, command= lambda: [fr1.grid_remove(), fr2.grid()]).place(bordermode=OUTSIDE, x=480, y=28)
logar_fr1 = Button(fr1, text=" Faça Login ", bg="#eb8334", fg="#fff",width=18, height=2, command= lambda: [fr1.grid_remove(), fr3.grid()]).place(bordermode=OUTSIDE, x=620, y=28)
func_fr1 = Button(fr1, text=" Área funcionario ", bg="#eb8334", fg="#fff",width=18, height=2, command= lambda: [fr1.grid_remove(), fr14.grid()]).place(bordermode=OUTSIDE, x=760, y=28)
...
voltar_fr2 = Button(fr2, text=" Voltar ", bg="#eb8334", fg="#fff",width=18, height=2, command= lambda: [fr2.grid_remove(), fr1.grid()]).place(bordermode=OUTSIDE, x=480, y=28)
logar_fr2 = Button(fr2, text=" Faça Login ", bg="#eb8334", fg="#fff",width=18, height=2, command= lambda: [fr2.grid_remove(), fr3.grid()]).place(bordermode=OUTSIDE, x=620, y=28)
func_fr2 = Button(fr2, text=" Área funcionario ", bg="#eb8334", fg="#fff",width=18, height=2, command= lambda: [fr2.grid_remove(), fr14.grid()]).place(bordermode=OUTSIDE, x=760, y=28)
...
cadastrar_fr2 = Button(fr2,  text=" Cadastrar ", bg="#eb8334", fg="#fff", font="Arial 15",
...
voltar_fr3 = Button(fr3, text=" Voltar ", bg="#eb8334", fg="#fff",
                    width=18, height=2, command= lambda: [fr3.grid_remove(), fr1.grid()]).place(bordermode=OUTSIDE, x=480, y=28)

cadastre_fr3 = Button(fr3, text=" Cadastre-se ", bg="#eb8334", fg="#fff",
                      width=18, height=2, command= lambda: [fr3.grid_remove(), fr2.grid()]).place(bordermode=OUTSIDE, x=620, y=28)

func_fr3 = Button(fr3, text=" Area Funcionario ", bg="#eb8334", fg="#fff",
                  width=18, height=2, command= lambda: [fr3.grid_remove(), fr14.grid()]).place(bordermode=OUTSIDE, x=760, y=28)
...
voltar_fr4 = Button(fr4, text=" Voltar ", bg="#eb8334", fg="#fff",
                    width=18, height=2, command= lambda: [fr4.grid_remove(), fr14.grid()]).place(bordermode=OUTSIDE, x=480, y=28)

cadastre_fr4 = Button(fr4, text=" Cadastre-se ", bg="#eb8334", fg="#fff",
                      width=18, height=2, command= lambda: [fr4.grid_remove(), fr14.grid()]).place(bordermode=OUTSIDE, x=620, y=28)

logar_fr4 = Button(fr4, text=" Login Usuario ", bg="#eb8334", fg="#fff",
                  width=18, height=2, command= lambda: [fr4.grid_remove(), fr3.grid()]).place(bordermode=OUTSIDE, x=760, y=28)

cadastrar_user_fr4 = Button(fr4, text=" Cadastrar user ", font=('Mongolian Baiti', '15'), bg="#eb8334",
                            fg="#fff", width=24, height=2, command= lambda: [fr4.grid_remove(), fr8.grid()]).place(bordermode=OUTSIDE, x=50, y=150)

deletar_user_fr4 = Button(fr4, text=" Excluir user ", font=('Mongolian Baiti', '15'), bg="#eb8334",
                          fg="#fff", width=24, height=2, command= lambda: [fr4.grid_remove(), fr6.grid()]).place(bordermode=OUTSIDE, x=50, y=300)

trocar_infos_fr4 = Button(fr4, text=" Mudar informações ", font=('Mongolian Baiti', '15'), bg="#eb8334",
                          fg="#fff", width=24, height=2, command= lambda: [fr4.grid_remove(), fr9.grid()]).place(bordermode=OUTSIDE, x=50, y=450)
...
voltar_fr5 = Button(fr5, text=" Voltar ", bg="#eb8334", fg="#fff",
                    width=18, height=2, command= lambda: [fr5.grid_remove(), fr1.grid()]).place(bordermode=OUTSIDE, x=480, y=28)

cadastre_fr5 = Button(fr5, text=" Cadastre-se ", bg="#eb8334", fg="#fff",
                      width=18, height=2, command= lambda: [fr5.grid_remove(), fr2.grid()]).place(bordermode=OUTSIDE, x=620, y=28)

excluir_fr5 = Button(fr5, text=" Excluir Conta ", bg="#eb8334", fg="#fff",
                   width=18, height=2, command= lambda: [fr5.grid_remove(), fr7.grid()]).place(bordermode=OUTSIDE, x=760, y=28)

deposito_fr5 = Button(fr5, text=" Deposito ", font=('Mongolian Baiti', '15'), bg="#eb8334",
                      fg="#fff", width=24, height=2, command= lambda: [fr5.grid_remove(), fr10.grid()]).place(bordermode=OUTSIDE, x=50, y=150)

saque_fr5 = Button(fr5, text=" Saque ", font=('Mongolian Baiti', '15'), bg="#eb8334",
                   fg="#fff", width=24, height=2, command= lambda: [fr5.grid_remove(), fr11.grid()]).place(bordermode=OUTSIDE, x=50, y=250)

trasferencia_fr5 = Button(fr5, text=" Trasferencia ", font=('Mongolian Baiti', '15'), bg="#eb8334",
                          fg="#fff", width=24, height=2, command= lambda: [fr5.grid_remove(), fr12.grid()]).place(bordermode=OUTSIDE, x=50, y=350)

extrato_fr5 = Button(fr5, text=" Extrato ", font=('Mongolian Baiti', '15'), bg="#eb8334",
                     fg="#fff", width=24, height=2, command= lambda: [fr5.grid_remove(), fr13.grid()]).place(bordermode=OUTSIDE, x=50, y=450)
...
voltar_fr6 = Button(fr6, text=" Voltar ", bg="#eb8334", fg="#fff",
                    width=18, height=2, command= lambda: [fr6.grid_remove(), fr4.grid()]).place(bordermode=OUTSIDE, x=480, y=28)

logout_fr6 = Button(fr6, text=" Logout ", bg="#eb8334", fg="#fff",
                    width=18, height=2, command= lambda: [fr6.grid_remove(), fr14.grid()]).place(bordermode=OUTSIDE, x=620, y=28)

logar_fr6 = Button(fr6, text=" Login Usuario ", bg="#eb8334", fg="#fff",
                   width=18, height=2, command= lambda: [fr6.grid_remove(), fr3.grid()]).place(bordermode=OUTSIDE, x=760, y=28)
...
voltar_fr7 = Button(fr7, text=" Voltar ", bg="#eb8334", fg="#fff",
                    width=18, height=2, command= lambda: [fr7.grid_remove(), fr4.grid()]).place(bordermode=OUTSIDE, x=480, y=28)

logout_fr7 = Button(fr7, text=" Logout ", bg="#eb8334", fg="#fff",
                    width=18, height=2, command= lambda: [fr7.grid_remove(), fr6.grid()]).place(bordermode=OUTSIDE, x=620, y=28)
...
voltar_fr8 = Button(fr8, text=" Voltar ", bg="#eb8334", fg="#fff",
                    width=18, height=2, command= lambda: [fr8.grid_remove(), fr4.grid()]).place(bordermode=OUTSIDE, x=480, y=28)

logout_fr8 = Button(fr8, text=" Logout ", bg="#eb8334", fg="#fff",
                    width=18, height=2, command= lambda: [fr8.grid_remove(), fr14.grid()]).place(bordermode=OUTSIDE, x=620, y=28)

logar_fr8 = Button(fr8, text=" Login Usuario  ", bg="#eb8334", fg="#fff",
                   width=18, height=2, command= lambda: [fr8.grid_remove(), fr3.grid()]).place(bordermode=OUTSIDE, x=760, y=28)
...
voltar_fr9 = Button(fr9, text=" Voltar ", bg="#eb8334", fg="#fff",
                    width=18, height=2, command= lambda: [fr9.grid_remove(), fr4.grid()]).place(bordermode=OUTSIDE, x=480, y=28)

logout_fr9 = Button(fr9, text=" Logout ", bg="#eb8334", fg="#fff",
                    width=18, height=2, command= lambda: [fr9.grid_remove(), fr14.grid()]).place(bordermode=OUTSIDE, x=620, y=28)

logar_fr9 = Button(fr9, text=" Login Usuario  ", bg="#eb8334", fg="#fff",
                   width=18, height=2, command= lambda: [fr9.grid_remove(), fr3.grid()]).place(bordermode=OUTSIDE, x=760, y=28)
...
voltar_fr10 = Button(fr10, text=" Voltar ", bg="#eb8334", fg="#fff",
                     width=18, height=2, command= lambda: [fr10.grid_remove(), fr5.grid()]).place(bordermode=OUTSIDE, x=480, y=28)

logout_fr10 = Button(fr10, text=" Logout ", bg="#eb8334", fg="#fff",
                     width=18, height=2, command= lambda: [fr10.grid_remove(), fr3.grid()]).place(bordermode=OUTSIDE, x=620, y=28)

excluir_fr10 = Button(fr10, text=" Excluir Conta  ", bg="#eb8334", fg="#fff",
                      width=18, height=2, command= lambda: [fr10.grid_remove(), fr7.grid()]).place(bordermode=OUTSIDE, x=760, y=28)

home_fr10 = Button(fr10, text=" Home ", font=('Mongolian Baiti', '15'), bg="#eb8334",
                   fg="#fff", width=24, height=2, command= lambda: [fr10.grid_remove(), fr5.grid()]).place(bordermode=OUTSIDE, x=50, y=150)

saque_fr10 = Button(fr10, text=" Saque ", font=('Mongolian Baiti', '15'), bg="#eb8334",
                    fg="#fff", width=24, height=2, command= lambda: [fr10.grid_remove(), fr11.grid()]).place(bordermode=OUTSIDE, x=50, y=250)

trasferencia_fr10 = Button(fr10, text=" Trasferencia ", font=('Mongolian Baiti', '15'), bg="#eb8334",
                           fg="#fff", width=24, height=2, command= lambda: [fr10.grid_remove(), fr12.grid()]).place(bordermode=OUTSIDE, x=50, y=350)

extrato_fr10 = Button(fr10, text=" Extrato ", font=('Mongolian Baiti', '15'), bg="#eb8334",
                      fg="#fff", width=24, height=2, command= lambda: [fr10.grid_remove(), fr13.grid()]).place(bordermode=OUTSIDE, x=50, y=450)
...
voltar_fr11 = Button(fr11, text=" Voltar ", bg="#eb8334", fg="#fff",
                     width=18, height=2, command= lambda: [fr11.grid_remove(), fr5.grid()]).place(bordermode=OUTSIDE, x=480, y=28)

logout_fr11 = Button(fr11, text=" Logout ", bg="#eb8334", fg="#fff",
                     width=18, height=2, command= lambda: [fr11.grid_remove(), fr3.grid()]).place(bordermode=OUTSIDE, x=620, y=28)

excluir_fr11 = Button(fr11, text=" Excluir Conta  ", bg="#eb8334", fg="#fff",
                      width=18, height=2, command= lambda: [fr11.grid_remove(), fr7.grid()]).place(bordermode=OUTSIDE, x=760, y=28)

deposito_fr11 = Button(fr11, text=" Deposito ", font=('Mongolian Baiti', '15'), bg="#eb8334",
                   fg="#fff", width=24, height=2, command= lambda: [fr11.grid_remove(), fr10.grid()]).place(bordermode=OUTSIDE, x=50, y=150)

home_fr11 = Button(fr11, text=" Home ", font=('Mongolian Baiti', '15'), bg="#eb8334",
                    fg="#fff", width=24, height=2, command= lambda: [fr11.grid_remove(), fr5.grid()]).place(bordermode=OUTSIDE, x=50, y=250)

trasferencia_fr11 = Button(fr11, text=" Trasferencia ", font=('Mongolian Baiti', '15'), bg="#eb8334",
                           fg="#fff", width=24, height=2, command= lambda: [fr11.grid_remove(), fr12.grid()]).place(bordermode=OUTSIDE, x=50, y=350)

extrato_fr11 = Button(fr11, text=" Extrato ", font=('Mongolian Baiti', '15'), bg="#eb8334",
                      fg="#fff", width=24, height=2, command= lambda: [fr11.grid_remove(), fr13.grid()]).place(bordermode=OUTSIDE, x=50, y=450)
...
voltar_fr12 = Button(fr12, text=" Voltar ", bg="#eb8334", fg="#fff",
                     width=18, height=2, command= lambda: [fr12.grid_remove(), fr5.grid()]).place(bordermode=OUTSIDE, x=480, y=28)

logout_fr12 = Button(fr12, text=" Logout ", bg="#eb8334", fg="#fff",
                     width=18, height=2, command= lambda: [fr12.grid_remove(), fr3.grid()]).place(bordermode=OUTSIDE, x=620, y=28)

excluir_fr12 = Button(fr12, text=" Excluir Conta  ", bg="#eb8334", fg="#fff",
                      width=18, height=2, command= lambda: [fr12.grid_remove(), fr7.grid()]).place(bordermode=OUTSIDE, x=760, y=28)

deposito_fr12 = Button(fr12, text=" Deposito ", font=('Mongolian Baiti', '15'), bg="#eb8334",
                       fg="#fff", width=24, height=2, command= lambda: [fr12.grid_remove(), fr10.grid()]).place(bordermode=OUTSIDE, x=50, y=150)

saque_fr12 = Button(fr12, text=" Saque ", font=('Mongolian Baiti', '15'), bg="#eb8334",
                    fg="#fff", width=24, height=2, command= lambda: [fr12.grid_remove(), fr11.grid()]).place(bordermode=OUTSIDE, x=50, y=250)

home_fr12 = Button(fr12, text=" Home  ", font=('Mongolian Baiti', '15'), bg="#eb8334",
                   fg="#fff", width=24, height=2, command= lambda: [fr12.grid_remove(), fr5.grid()]).place(bordermode=OUTSIDE, x=50, y=350)

extrato_fr12 = Button(fr12, text=" Extrato ", font=('Mongolian Baiti', '15'), bg="#eb8334",
                      fg="#fff", width=24, height=2, command= lambda: [fr12.grid_remove(), fr13.grid()]).place(bordermode=OUTSIDE, x=50, y=450)
...
voltar_fr13 = Button(fr13, text=" Voltar ", bg="#eb8334", fg="#fff",
                     width=18, height=2, command= lambda: [fr13.grid_remove(), fr5.grid()]).place(bordermode=OUTSIDE, x=480, y=28)

logout_fr13 = Button(fr13, text=" Logout ", bg="#eb8334", fg="#fff",
                     width=18, height=2, command= lambda: [fr13.grid_remove(), fr3.grid()]).place(bordermode=OUTSIDE, x=620, y=28)

excluir_fr13 = Button(fr13, text=" Excluir Conta  ", bg="#eb8334", fg="#fff",
                      width=18, height=2, command= lambda: [fr13.grid_remove(), fr7.grid()]).place(bordermode=OUTSIDE, x=760, y=28)

deposito_fr13 = Button(fr13, text=" Deposito ", font=('Mongolian Baiti', '15'), bg="#eb8334",
                       fg="#fff", width=24, height=2, command= lambda: [fr13.grid_remove(), fr10.grid()]).place(bordermode=OUTSIDE, x=50, y=150)

saque_fr13 = Button(fr13, text=" Saque ", font=('Mongolian Baiti', '15'), bg="#eb8334",
                    fg="#fff", width=24, height=2, command= lambda: [fr13.grid_remove(), fr11.grid()]).place(bordermode=OUTSIDE, x=50, y=250)

trasferencia_fr13 = Button(fr13, text=" Transferencia  ", font=('Mongolian Baiti', '15'), bg="#eb8334",
                   fg="#fff", width=24, height=2, command= lambda: [fr13.grid_remove(), fr12.grid()]).place(bordermode=OUTSIDE, x=50, y=350)

home_fr13 = Button(fr13, text=" Home ", font=('Mongolian Baiti', '15'), bg="#eb8334",
                      fg="#fff", width=24, height=2, command= lambda: [fr13.grid_remove(), fr5.grid()]).place(bordermode=OUTSIDE, x=50, y=450)
